...
import { signUpController, signInController, getUserByUuidController, getAllUsersController, updateUserController, deleteUserController, getUsersByStatusController } from "./dependencies";
...
userRouter.get('/status', getUsersByStatusController.run.bind(getUsersByStatusController))
